...
<div
	class="overflow-hidden w-full inline-flex items-center py-2 px-3 bg-gray-50 rounded-lg dark:bg-gray-700"
>
	<button
		type="button"
	...
	<textarea
		id="chat"
		rows="1"
		class="block mx-4 p-2.5 max-h-[300px] w-full resize-none text-gray-900 bg-white rounded-lg border-gray-300"
